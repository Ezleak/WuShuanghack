...
public class ModuleManager {
    ...
    public static void init() {
        ...
        registerNewModule(CivBreaker.class);
        registerNewModule(AutoPush.class);
        registerNewModule(SurroundPlus.class);
        registerNewModule(AutoPushAi.class);
        registerNewModule(FeetMiner.class);
        registerNewModule(AntiBurrow.class);
        registerNewModule(AntiPiston.class);
        //Misc
        ...
        //registerNewModule(SilentPickel.class);
        registerNewModule(ChestStealer.class);
        //Movement
        ...
        registerNewModule(TickShift.class);

        //Player
     //   registerNewModule(AntiBurrow2.class);
       ...
       // registerNewModule(AbInstantMine.class);
        registerNewModule(CityBoss.class);
        //Render
        ...
        registerNewModule(LowHPScreen.class);
        ...
        //registerNewModule(Indicators.class);
